...
public class MainActivity2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final MediaPlayer mp1=MediaPlayer.create(getApplicationContext(), R.raw.nineteen);
        final MediaPlayer mp2=MediaPlayer.create(getApplicationContext(), R.raw.twenty);
        final MediaPlayer mp3=MediaPlayer.create(getApplicationContext(), R.raw.twentyone);
        final MediaPlayer mp4=MediaPlayer.create(getApplicationContext(), R.raw.twentytwo);
        final MediaPlayer mp5=MediaPlayer.create(getApplicationContext(), R.raw.twentythree);
        final MediaPlayer mp6=MediaPlayer.create(getApplicationContext(), R.raw.twentyfour);
        final MediaPlayer mp7=MediaPlayer.create(getApplicationContext(), R.raw.twentyfive);
    ...
    public void nummenu(View view) {
        Intent intent=new Intent(MainActivity2.this, Sub_list.class);
