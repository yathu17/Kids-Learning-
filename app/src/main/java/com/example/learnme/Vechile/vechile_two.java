...
public class vechile_two extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_vechile_two);
        ...
        final MediaPlayer mp1=MediaPlayer.create(getApplicationContext(), R.raw.ambulance);
        final MediaPlayer mp2=MediaPlayer.create(getApplicationContext(), R.raw.threewheeler);
        final MediaPlayer mp3=MediaPlayer.create(getApplicationContext(), R.raw.helicopter);
        final MediaPlayer mp4=MediaPlayer.create(getApplicationContext(), R.raw.flight);
        final MediaPlayer mp5=MediaPlayer.create(getApplicationContext(), R.raw.boat);
    ...
    public void Vecmenu(View view) {
        Intent intent=new Intent(vechile_two.this, Sub_list.class);
